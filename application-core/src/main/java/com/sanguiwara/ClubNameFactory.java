...
public class ClubNameFactory {

    public static String generateRandomFrenchBasketClubName() {
     ...
     */
    public static String generateRandomFrenchBasketClubName(Set<String> usedNames) {
    ...
    private static String buildName(ThreadLocalRandom rnd) {
